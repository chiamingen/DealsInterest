//
//  ItemCategoryTableTableViewController.m
//  DealInterest2
//
...
@interface ItemCategoryTableTableViewController ()

@end

@implementation ItemCategoryTableTableViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.delegate returnFromCategoryTable:category];
}
