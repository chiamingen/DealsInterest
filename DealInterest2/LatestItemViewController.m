...
- (void)viewDidLoad
{
    ...
    __weak LatestItemViewController *tmpSelf= self;
...
-(void)getLatestItem:(BOOL)isPullToRefresh infiniteScroll:(BOOL)infiniteScroll {
    ...
    NSString *url = [NSString stringWithFormat:@"%@%@", ServerBaseUrl, @"json/item.getLatestItem/"];
